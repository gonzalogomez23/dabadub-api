...
const PostCard = ({post}) => {
  return (
    <Link  to={`/posts/${post.slug}`} className="group flex flex-col max-w-sm bg-white/40 border border-border1 hover:border-secondary hover:bg-gradient-to-tl from-light1 to-transparent rounded-lg shadow-sm gap-3 p-6">
